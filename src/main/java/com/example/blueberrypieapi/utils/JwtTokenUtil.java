...
public class JwtTokenUtil implements Serializable {
    ...
    public String getTokenFromRequest(HttpServletRequest request) {
        String token = request.getHeader(jwtConfig.getHeader());
        return token.substring(jwtConfig.getPrefix().length());
    }
    ...
    public void isUserToken(String name,HttpServletRequest request)throws RuntimeException{
        String uName = this.getUsernameFromToken(this.getTokenFromRequest(request));
        List<String> roles = this.getRolesFromToken(this.getTokenFromRequest(request));
